...
class OpticalSystem(nn.Module):
    def __init__(self, device="cpu", target_mode_nbs=(2,2), with_minimize_losses=True,downsampling=2):
        ...
        self.list_target_files = generate_target_profiles_specific_modes_2D(XY_grid=self.ft_lens.XY_output_grid,
...
if __name__ == "__main__":
    ...
    run_name = "Optim_2D"  # Optional: provide a custom run name
