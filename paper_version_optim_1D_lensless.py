...
class OpticalSystem(nn.Module):
    def __init__(self, device="cpu", target_mode_nb=2, with_minimize_losses=True, downsampling=2):
        ...
        self.list_target_files = generate_target_profiles_specific_modes(XY_grid=self.simulation.XY_grid, list_modes_nb=[0,1,2,3,4,5,6,7,8])
...
if __name__ == "__main__":
    ...
    run_name = "Optim_1D_lensless"  # Optional: provide a custom run name
    ...
    run_name = "Optim_1D_lensless_downsampled_factor_2"  # Optional: provide a custom run name
    run_multiple_tests(data_dir, target_modes, num_runs_per_mode, num_epochs, run_name,downsampling=4)

    run_name = "Optim_1D_lensless_downsampled_factor_4"  # Optional: provide a custom run name
    run_multiple_tests(data_dir, target_modes, num_runs_per_mode, num_epochs, run_name,downsampling=8)

    run_name = "Optim_1D_lensless_downsampled_factor_8"  # Optional: provide a custom run name
